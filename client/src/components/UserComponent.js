  ...
  return (
    <div className="relative bg-black">
      {isLoggedIn ? (
        ...
        <button
          className="hidden flex items-center bg-black text-[#ac94f4] border-2 border-[#ac94f4] space-x-2 mt-5 opacity-90 hover:opacity-80 cursor-pointer rounded-full p-2 pr-2"
          onClick={handleLogin}
        >
          <FaGoogle size={24} />
          <span className="hidden lg:block text-[#ac94f4]">Sign in with Google</span>
        </button>
      )}
    </div>
  );
